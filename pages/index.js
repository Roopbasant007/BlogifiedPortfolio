...
import { createClient } from "next-sanity"; // to connect sanity with next js after installing npm install next-sanity
import PortableText from "react-portable-text"; // to display the content aquired from sanity content lake server to client
...
export default function Home({ blogs, profile }) {
  ...
  useEffect(() => {
    console.log(profile.skills.skill1.name);
    console.log(profile.skills.skill1.rating);
  }, []);
            ...
            <div>
                ...
                <div className="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
                  <div className="flex flex-col items-center justify-center lg:flex-row">
                    <div className="rounded-full border-8 border-primary shadow-xl">
                      <img
                        src={builder.image(profile.pImage).width(200).url()}
                    ...
                    <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                      ...
                      <Link href="./blog">
                        <div className="text-center md:text-left">
                          <button className=" bg-purple-600 text-white rounded-xl px-2 py-1 mt-4 ">
                            All Blogs
                          </button>
                        </div>
                      </Link>
                    ...
                    <div>
                      <div className="flex items-end justify-between">
                        <h4 className="font-body font-semibold uppercase text-black">
                          {profile.skills.skill1.name}
                        </h4>
                        <h3 className="font-body text-3xl font-bold text-primary">
                          {profile.skills.skill1.rating}%
                        </h3>
                      </div>
                      <div className="mt-2 h-3 w-full rounded-full bg-lila">
                        <div
                          className="h-3 rounded-full bg-primary"
                          style={{ width: profile.skills.skill1.rating + "%" }}
                        ></div>
                      </div>
                    </div>
                    <div className="pt-6">
                      <div className="flex items-end justify-between">
                        <h4 className="font-body font-semibold uppercase text-black">
                          {profile.skills.skill2.name}
                        </h4>
                        <h3 className="font-body text-3xl font-bold text-primary">
                          {profile.skills.skill2.rating}%
                        </h3>
                      </div>
                      <div className="mt-2 h-3 w-full rounded-full bg-lila">
                        <div
                          className="h-3 rounded-full bg-primary"
                          style={{ width: profile.skills.skill2.rating + "%" }}
                        ></div>
                      </div>
                    </div>
                    <div className="pt-6">
                      <div className="flex items-end justify-between">
                        <h4 className="font-body font-semibold uppercase text-black">
                          {profile.skills.skill3.name}
                        </h4>
                        <h3 className="font-body text-3xl font-bold text-primary">
                          {profile.skills.skill3.rating}%
                        </h3>
                      </div>
                      <div className="mt-2 h-3 w-full rounded-full bg-lila">
                        <div
                          className="h-3 rounded-full bg-primary"
                          style={{ width: profile.skills.skill3.rating + "%" }}
                        ></div>
                      </div>
                    </div>
                    <div className="pt-6">
                      <div className="flex items-end justify-between">
                        <h4 className="font-body font-semibold uppercase text-black">
                          {profile.skills.skill4.name}
                        </h4>
                        <h3 className="font-body text-3xl font-bold text-primary">
                          {profile.skills.skill4.rating}%
                        </h3>
                      </div>
                      <div className="mt-2 h-3 w-full rounded-full bg-lila">
                        <div
                          className="h-3 rounded-full bg-primary"
                          style={{ width: profile.skills.skill4.rating + "%" }}
                        ></div>
                      </div>
                    </div>
                    <div className="pt-6">
                      <div className="flex items-end justify-between">
                        <h4 className="font-body font-semibold uppercase text-black">
                          {profile.skills.skill5.name}
                        </h4>
                        <h3 className="font-body text-3xl font-bold text-primary">
                          {profile.skills.skill5.rating}%
                        </h3>
                      </div>
                      <div className="mt-2 h-3 w-full rounded-full bg-lila">
                        <div
                          className="h-3 rounded-full bg-primary"
                          style={{ width: profile.skills.skill5.rating + "%" }}
                        ></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group rounded px-8 py-12 shadow hover:bg-primary">
                    ...
                    <div className="text-center">
                      <h3 className="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
                        {profile.servicesIOffer.service1.name}
                      </h3>
                      <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                        {profile.servicesIOffer.service1.about}
                      </p>
                    </div>
                  </div>
                  <div className="group rounded px-8 py-12 shadow hover:bg-primary">
                    ...
                    <div className="text-center">
                      <h3 className="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
                        {profile.servicesIOffer.service2.name}
                      </h3>
                      <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                        {profile.servicesIOffer.service2.about}
                      </p>
                    </div>
                  </div>
                  <div className="group rounded px-8 py-12 shadow hover:bg-primary">
                    <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
                      <div className="hidden group-hover:block">
                        <img
                          src="/assets/img/video-editing-colored.png"
                          alt=""
                        />
                      </div>
                      <div className="block group-hover:hidden">
                        <img src="/assets/img/video-editing-black.png" alt="" />
                      </div>
                    </div>
                    <div className="text-center">
                      <h3 className="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
                        {profile.servicesIOffer.service3.name}
                      </h3>
                      <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                        {profile.servicesIOffer.service3.about}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="container py-16 md:py-20" id="portfolio">
                ...
                <div className="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
                  <a
                    href="https://dogcare.onrender.com"
                    className="mx-auto transform transition-all hover:scale-105 md:mx-0"
                  >
                    <img
                      src="/assets/img/portfolio-dogcare.png"
                          ...
                          <div className="md:-mt-1 md:pl-8">
                            ...
                            <div className="pt-2">
                              <span className="block font-body text-black">
                                ...
                                adipiscing elit. Vestibulum mattis felis vitae
                                risus pulvinar tincidunt. Nam ac venenatis enim.
                              </span>
                            </div>
                          </div>
                        </div>
              ...
              <div className="bg-grey-50" id="blog">
                <div className="container py-16 md:py-20">
                  ...
                  <Link href="./blog">
                    <div className="text-center">
                      <button className=" bg-purple-600 text-white text-xl font-semibold rounded-xl px-3 py-2 mt-16 ">
                        All Blogs
                      </button>
                    </div>
                  </Link>
              ...
              <div className="container py-16 md:py-20" id="contact">
                ...
                <h4 className="pt-6 text-center font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
                  Send me message to Hire me as a Web Developer
                </h4>
                <div className="mx-auto w-full pt-5 text-center sm:w-2/3 lg:pt-6">
                  <p className="font-body text-grey-10">
                    Here, you can attach some description about the job.
                  </p>
                </div>
              ...
              <a href={profile.addressOnGoogleMap}>
                <div
...
export async function getServerSideProps(context) {
  ...
  // Fetch data from external API using GROQ(graph query language) query
  const query = `*[_type == "blog"][0...3]`; // we have use slicing to fetch only 3 blogs here
